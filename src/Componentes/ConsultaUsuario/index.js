...
const Profissional = () => {
  ...
  const setLabelSuccess = (label) => {
    ...
    label.innerHTML = fieldNames[label.htmlFor];
  };
  ...
  const cadastrar = () => {
    ...
    cadastrarProfissional(usuario)
      .then((response) => {
        ...
        setTimeout(() => {
          navigate("/"); // Redirecione para a página Home após 2 segundos
        }, 2000);
      })
      .catch((error) => {
      ...
      <div className="card">
        ...
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="labelNome" htmlFor="nome">
            Nome
          </label>
        </div>
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="Profissional" htmlFor="profissional">
            Profissional
          </label>
        </div>
        <div className="label-float">
        ...
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="labelCnpj" htmlFor="cnpj">
            CNPJ / MEI
          </label>
        </div>
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="labelAreaDeAtuacao" htmlFor="areadeatuacao">
            Área de Atuação
          </label>
        </div>
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="labelTelefone" htmlFor="telefone">
            Telefone
          </label>
        </div>
        <div className="label-float">
        ...
        <div className="label-float">
          <input
            ...
            required
          />
          <label id="labelConfirmSenha" htmlFor="confirmSenha">
            Confirmar Senha
          </label>
        </div>
